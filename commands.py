...
BOT_PREFIX = "e!"
BOT_TOKEN = "NjA3NTU4NTUyODk4MzcxNTk0.XUjIuQ.uMIGsle0D6G7fW-XqoKGitUNIoQ"
...
@client.command(name='helpcreate', pass_context=True)
async def helpcreate(ctx):
    embed = discord.Embed(color=discord.Color.orange())
    embed.set_author(name='Help | Create', icon_url='https://cdn.discordapp.com/attachments/604041168963108875/604041204455309324/IMG_20190726_013231.png')
    embed.add_field(
        name='Title',
...
async def create(ctx):
    ...
    if ctx.message.author.server_permissions.administrator:
        ...
        announcement.set_author(name=input[0], icon_url='https://cdn.discordapp.com/attachments/604041168963108875/604041204455309324/IMG_20190726_013231.png')
        input = input[1:]
...
@client.command(name='send', pass_context=True)
